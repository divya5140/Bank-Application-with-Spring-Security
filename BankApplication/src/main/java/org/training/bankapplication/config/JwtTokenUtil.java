...
import static org.training.bankapplication.entity.Constants.ACCESS_TOKEN_VALIDITY_SECONDS;
import static org.training.bankapplication.entity.Constants.SIGNING_KEY;
...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(Customer user, List<SimpleGrantedAuthority> authorities) {
